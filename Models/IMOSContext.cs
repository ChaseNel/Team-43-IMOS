...
namespace IMOSApi.Models
{
    public partial class IMOSContext : DbContext
    {
        ...
        public virtual DbSet<Projectmaterialrequeststatus> Projectmaterialrequeststatuses { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Orderline>(entity =>
            {
                ...
                entity.HasOne(d => d.OrderStatus)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ORDERLINE_ORDERSTATUS");
            ...
            modelBuilder.Entity<Task>(entity =>
            {
                ...
                entity.Property(e => e.TaskcompletionstatusId).HasColumnName("TASKCOMPLETIONSTATUS_ID");

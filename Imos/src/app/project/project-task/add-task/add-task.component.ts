  ...
  constructor(private fb: FormBuilder,
    ...
    private router: Router,
     private service: ServiceService,
      ...
      private MatDialog: MatDialogRef<AddTaskComponent>) { }
      ...
      AddTask(){
        if(this.AddFormGroup.valid)
        {
          ...
          this.service.addTaskproject(this.data.id,this.AddFormGroup.value)
          .subscribe(() => {
            this.AddFormGroup.reset();
            this.snackBar.open(`Successfully added a Task `, 'X', {duration: 5000});

...
@Component({
  selector: 'app-list-of-incidents-report',
  templateUrl: './list-of-incidents-report.component.html',
  styleUrls: ['./list-of-incidents-report.component.css'],
  providers: [DatePipe]
})
export class ListOfIncidentsReportComponent implements OnInit {
  Incidents:incident[] =[];
  ...
  public downloadPDF(): void {
    ...
    html2canvas(DATA).then((canvas) => {
      ...
      PDF.save('Project Incidents Report.pdf');
    });
  }
